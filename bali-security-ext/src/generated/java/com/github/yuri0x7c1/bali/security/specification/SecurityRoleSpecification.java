...
/**
 * SecurityRole Criteria
 */
@Slf4j
public class SecurityRoleSpecification implements Specification<SecurityRole> {

	QbModel criteria;

	public SecurityRoleSpecification(QbModel criteria) {
		this.criteria = criteria;
	}

	public Predicate buildPredicate(QbGroup group, Root<SecurityRole> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
	...
	@Override
	public Predicate toPredicate(Root<SecurityRole> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
