...
/**
 * SecurityUser Criteria
 */
@Slf4j
public class SecurityUserSpecification implements Specification<SecurityUser> {

	QbModel criteria;

	public SecurityUserSpecification(QbModel criteria) {
		this.criteria = criteria;
	}

	public Predicate buildPredicate(QbGroup group, Root<SecurityUser> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
	...
	@Override
	public Predicate toPredicate(Root<SecurityUser> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
