 ...
 */
com_github_yuri0x7c1_bali_ui_timeline_Timeline = function () {
  ...
  this.setCustomTime = function (time, id) {
	 ...
	 */
	this.setCustomTimeMarker = function setCustomTimeMarker(title, id, editable) {
 ...
 */
  ...
  // -----------------------
  // Init component
  this.registerRpc("com.github.yuri0x7c1.bali.ui.timeline.shared.TimelineClientRpc", this);

  console_log("Creating timeline.");

  // Create timeline witg disabled xss. Xss settings not applied when setOptions called.
  // TODO: make better solution for xss configuration
  timeline = new vis.Timeline(element, itemsDataSet, groupsDataSet, {xss: {disabled: true}});
