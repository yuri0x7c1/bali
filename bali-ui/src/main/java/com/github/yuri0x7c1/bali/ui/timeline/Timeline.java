...
import com.github.yuri0x7c1.bali.ui.timeline.ClickListener.ClickEvent;
import com.github.yuri0x7c1.bali.ui.timeline.ContextMenuListener.ContextMenuEvent;
import com.github.yuri0x7c1.bali.ui.timeline.DoubleClickListener.DoubleClickEvent;
import com.github.yuri0x7c1.bali.ui.timeline.shared.EventProperties;
import com.github.yuri0x7c1.bali.ui.timeline.shared.TimelineClientRpc;
import com.github.yuri0x7c1.bali.ui.timeline.shared.TimelineServerRpc;
...
@JavaScript({"vis-timeline-graph2d.min.js", "timeline_connector.js"})
public class Timeline extends AbstractJavaScriptComponent implements
  ...
  private CustomTimeProvider customTimeProvider;
   ...
   * period starting "now" unless {@link #setWindow(java.util.Date, java.util.Date, com.github.yuri0x7c1.bali.ui.timeline.TimelineMethodOptions.SetWindow)
   * } is called.
   *
   * @param caption the caption of the component
   * @param provider the provider of timeline items
   ...
   * from the date set with the last call to {@link #setWindow(java.util.Date, java.util.Date, com.github.yuri0x7c1.bali.ui.timeline.TimelineMethodOptions.SetWindow)
  ...
  public void setCustomTimeProvider(CustomTimeProvider provider) {
	  customTimeProvider = provider;
	  if (provider != customTimeProvider) {
		  customTimeProvider = provider;
		  markAsDirty();
	  }
  }
   ...
   * calling {@link #setSelection(java.util.Collection, com.github.yuri0x7c1.bali.ui.timeline.TimelineMethodOptions.SetSelection)
  ...
  private void sendItemsToClient() {
	...
	private void sendCustomTimesToClient() {
		if (customTimeProvider == null)
			return;
		for (CustomTime ct : customTimeProvider.getCustomTimes()) {
			clientRpc.addCustomTime(ct.getTime().getTime(), ct.getId());
			if (StringUtils.isNotBlank(ct.getTitle())) {
				clientRpc.setCustomTimeTitle(ct.getTitle(), ct.getId());
			}
			if (ct.isMarker()) {
				clientRpc.setCustomTimeMarker(StringUtils.isNotBlank(ct.getTitle()) ? ct.getTitle() : ct.getId(),
						ct.getId(), ct.isEditable());
			}
		}
	}
...
//	clientRpc.setCustomTimeTitle(title, id);
//  }
//
//  /**
...
//	  clientRpc.setCustomTimeMarker(title, id, editable);
//  }
