...
package com.github.yuri0x7c1.bali.ui.timeline.shared;
...
public interface TimelineClientRpc extends ClientRpc {
   ...
   * @param id
   */
  void setCustomTimeTitle(String title, String id);
   ...
   * @param editable
   */
  void setCustomTimeMarker(String title, String id, boolean editable);
