...
import static com.github.yuri0x7c1.bali.ui.app.layout.builder.design.Styles.*;
...
public class MenuHeader extends VerticalLayout {
    ...
    public MenuHeader(String title, String subtitle, Image image) {
        ...
        setMargin(false); // FIXME you do not need to set margin twice here and later with MarginInfo.
                          // remove this call
        setSpacing(false);
        setMargin(new MarginInfo(true, false, false, false));

        // FIXME I added curly braces here. This is not enforced by the compiler but is
        // good practice and makes code more readable
        if (image != null) {
            addComponent(image);
        }
